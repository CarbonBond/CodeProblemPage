...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_containsDuplicate')) {
        Object.defineProperty(Module['ready'], '_containsDuplicate', { configurable: true, get: function() { abort('You are getting _containsDuplicate on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_containsDuplicate', { configurable: true, set: function() { abort('You are setting _containsDuplicate on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var ASM_CONSTS = {
  66860: function() {return withBuiltinMalloc(function () { return allocateUTF8(Module['UBSAN_OPTIONS'] || 0); });},  
 66958: function() {var setting = Module['printWithColors']; if (setting != null) { return setting; } else { return ENVIRONMENT_IS_NODE && process.stderr.isTTY; }}
};
...
/** @type {function(...*):?} */
var _containsDuplicate = Module["_containsDuplicate"] = createExportWrapper("containsDuplicate");
